 ...
 * @author korisnik
 */
public class ObrisiOglas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            st.executeUpdate("DELETE FROM slike WHERE IDOglas = '"+IDOglas+"';");        
            st2.executeUpdate("DELETE FROM oglas WHERE IDOglas = '"+IDOglas+"';");
                   
                st.close();
                st2.close();
                con.close();

                request.setAttribute("jej","Uspešno izbrisan oglas!");
