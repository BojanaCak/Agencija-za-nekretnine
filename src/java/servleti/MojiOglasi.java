 ...
 * @author korisnik
 */
public class MojiOglasi extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
           ...
           String sql = "Select KorisnikID from korisnik where Email = '"+email+"'";
      ...
      try{
          KorisnikID = (int)sesija.getAttribute("kid");
           Class.forName("com.mysql.jdbc.Driver");
           con = DriverManager.getConnection("jdbc:mysql://localhost:3306/nekretnine", "root", "");
          Statement stmt=con.createStatement();
          String upit="select `IDOglas`, `KorisnikID`, `Struktura`, `Kvadratura`, `Status`, `Cena`, `Grad`, `Opstina`, `Adresa`, `Tip`, `Slika` from oglas where `KorisnikID`= '"+KorisnikID+"'";
